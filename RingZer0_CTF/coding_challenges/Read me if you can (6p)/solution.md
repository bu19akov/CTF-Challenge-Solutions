...
- Web page with the code on the image

## Solution

We need to extract the code from image. My solution doesn't work in 100%, but still it can do the task with couple of runs:
